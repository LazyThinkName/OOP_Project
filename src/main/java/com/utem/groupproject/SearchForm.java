...
public class SearchForm extends javax.swing.JFrame {
    ...
    public void addFoodToTable(ArrayList<Food> result){
    ...
    public void addDrinkToTable(ArrayList<Drink> result){
        DefaultTableModel model= (DefaultTableModel) itemTable.getModel();
        Object rowData[]=new Object[7];
        for (int i=0;i<result.size();i++)
        {
    ...
    private void initComponents() {
        ...
        if (itemTable.getColumnModel().getColumnCount() > 0) {
            itemTable.getColumnModel().getColumn(0).setHeaderValue("Food ID");
            itemTable.getColumnModel().getColumn(1).setHeaderValue("Name");
            itemTable.getColumnModel().getColumn(2).setHeaderValue("Type");
            itemTable.getColumnModel().getColumn(3).setHeaderValue("Arrival Date");
            itemTable.getColumnModel().getColumn(4).setHeaderValue("Expiry Date");
            itemTable.getColumnModel().getColumn(5).setHeaderValue("Price");
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        ArrayList<Drink> resultDrink = new ArrayList<>();
        ...
        if ("Food".equals(type)){
            ...
            case 1:
                try {
                    resultFood = manageFood.searchFood(jTextField3.getText(), searchBy);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                }   break;
            case 2:
                try {
                    resultFood = manageFood.searchFood(sdf.format(arrivalDateChooser.getDate()), searchBy);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
            ...
            case 3:
                try {
                    resultFood = manageFood.searchFood(sdf.format(expiryDateChooser.getDate()), searchBy);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(null, "No Item Found!");
                }   break;
            case 4:
                ...
                try {
                    resultFood = manageFood.searchFood(maxPrice,minPrice);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(null, "No Item Found!");
                }   break;
            case 5:
                ...
                try {
                    resultFood = manageFood.searchFood(maxQty,minQty);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(null, "No Item Found!");
                }   break;
        ...
        addFoodToTable(resultFood);
            ...
            case 1:
                try {
                    resultDrink = manageDrink.searchDrink(jTextField3.getText(), searchBy);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                }   break;
            case 2:
                try {
                    resultDrink = manageDrink.searchDrink(sdf.format(arrivalDateChooser.getDate()), searchBy);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                }   break;
            case 3:
                try {
                    resultDrink = manageDrink.searchDrink(sdf.format(expiryDateChooser.getDate()), searchBy);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                }   break;
            case 4:
                ...
                double minPrice=Double.parseDouble(minTextField.getText());
                try {
                    resultDrink = manageDrink.searchDrink(maxPrice,minPrice);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                }   break;
            case 5:
                ...
                int minQty=Integer.parseInt(minTextField.getText());
                try {
                    resultDrink = manageDrink.searchDrink(maxQty,minQty);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(SearchForm.class.getName()).log(Level.SEVERE, null, ex);
                }   break;
            default:
